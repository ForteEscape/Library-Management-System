...
class BookRentalRepositoryTest {
  ...
  @DisplayName("회원 도서 회원 번호로 대여 기록을 조회할 수 있다. 조회는 한 페이지에 5개까지 표시된다.")
  @Test
  public void findRentalPageByMemberCode() throws Exception {
    ...
    // when
    Page<Rental> rentalResult1 = bookRentalRepository.findRentalPageByMemberCode(
        "123456", pageRequest1);
    List<Rental> content1 = rentalResult1.getContent();

    Page<Rental> rentalResult2 = bookRentalRepository.findRentalPageByMemberCode(
        "123456", pageRequest2);
    List<Rental> content2 = rentalResult2.getContent();
